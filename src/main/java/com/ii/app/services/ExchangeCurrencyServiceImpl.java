...
public class ExchangeCurrencyServiceImpl implements ExchangeCurrencyService {
	...
	/*
	 * @Autowired public ExchangeCurrencyServiceImpl(ExchangeCurrencyRepository
	 * exchangeCurrencyRepository, ExchangeCurrencyMapper exchangeCurrencyMapper,
	 * BankAccountRepository bankAccountRepository, CurrencyConverter
	 * currencyConverter, Constants constants, SaldoRepository saldoRepository,
	 * CurrencyTypeRepository currencyTypeRepository) {
	 * this.exchangeCurrencyRepository = exchangeCurrencyRepository;
	 * this.exchangeCurrencyMapper = exchangeCurrencyMapper;
	 * this.bankAccountRepository = bankAccountRepository; this.currencyConverter =
	 * currencyConverter; this.constants = constants; this.currencyTypeRepository =

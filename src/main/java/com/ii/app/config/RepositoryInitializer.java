    ...
    public InitializingBean intializeRepo() {
        return () -> {
            ...
            if (userRepository.findAll().isEmpty()) {
				/*
				 * Address address = Address.builder() .city("Tunis") .houseNumber("08")
				 * .name("Tunisia") .surname("Ghazala") .phoneNumber("2036") .postCode("20-36")
				 * .dateOfBirth(Instant.now()) .street("ESPRIT") .build();
				 */
             ...
             //       .transactionTemplates(new HashSet<>())
				...
				/*
				 * Address address2 = Address.builder() .city("Tunis") .houseNumber("32")
				 * .name("Asma") .surname("Nouri") .phoneNumber("52103314") .postCode("60-201")
				 * .dateOfBirth(Instant.now()) .street("Ariana") .build();
				 */
				...
				/*
				 * Address address3 = Address.builder() .city("Tunis") .houseNumber("92")
				 * .name("Razi") .surname("Fertani") .dateOfBirth(Instant.now())
				 * .phoneNumber("692193823") .postCode("50-221") .street("Sokra") .build();
				 */
